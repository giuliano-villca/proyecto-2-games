...
habilidades_disponibles = ["area_steal", "panel_grab", "heladera", "jardin", "bola de fuego", "sanacion",
"zona volcanica", "temblores", "terremoto", "espada", "espada lunar"]; // Habilidades disponibles
