...
if (instance_exists(obj_enemy)) {
    ...
    switch (obj_enemy.grupo_habilidades_activo_enemy) {
        case 0:
			...
			texto_izquierda_enemy = "grupo 3 (e-nye)";
            texto_derecha_enemy = "grupo 2 (P)";
            break;
        case 1:
            grupo_texto_enemy = "Equipamiento 2";
			texto_izquierda_enemy = "grupo 1 ((e-nye))";
            texto_derecha_enemy = "grupo 3 (P)";
            break;
        case 2:
            grupo_texto_enemy = "Equipamiento 3";
			texto_izquierda_enemy = "grupo 2 ((e-nye))";
            texto_derecha_enemy = "grupo 1 (P)";
            break;
    }
}
...
for (var i = 0; i < 4; i++) {
    ...
    if (global.habilidades_seleccionadas_enemy[habilidad_indice] != -1) {
		...
		var cooldown = global.habilidad_estado_enemy[? habilidad_nombre];
		if (cooldown > 0) {
