    ...
    if (tipo_entidad == "obj_enemy") {
        ...
        switch (habilidad) {
				case "area_steal":
                    ...
                    global.habilidad_estado_enemy[? habilidad] = 6 * room_speed; // 6 segundos de cooldown
                    break;
                case "panel_grab":
                    panel_grab(entity_type);
                    global.habilidad_estado_enemy[? habilidad] = 2 * room_speed; // 2 segundos de cooldown
                    break;
                case "heladera":
                    heladera();
                ...
                case "terremoto":
                    terremoto();
                    global.habilidad_estado_enemy[? habilidad] = 1 * room_speed; // 25 segundos de cooldown
                    break;
                case "espada":
                    espada(entity_type);
