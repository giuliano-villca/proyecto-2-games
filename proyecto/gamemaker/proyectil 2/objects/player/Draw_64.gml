...
draw_rectangle(10, 10, 110, 30, false); // Dibujar un rectángulo para el fondo de la barra de vida
draw_set_color(c_red); // Establecer el color en rojo para el indicador de vida
draw_rectangle(10, 10, 10 + vida, 30, false); // Dibujar la barra de vida basada en la variable player_health
