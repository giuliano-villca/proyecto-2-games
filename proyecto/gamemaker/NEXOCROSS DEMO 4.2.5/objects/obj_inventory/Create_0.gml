...
"escudo", "reparacion", "torreta ballesta", "muro", "tornado", "aro electrico"]; // Habilidades disponibles
...
"invisible", "escudo", "reparacion", "torreta ballesta", "muro", "tornado", "aro electrico"]; // Habilidades disponibles del enemigo
