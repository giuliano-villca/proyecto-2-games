...
"zona volcanica", "temblores", "terremoto", "espada", "espada lunar", "heladera", "invisible"]; // Habilidades disponibles
...
"sanacion", "zona volcanica", "temblores", "terremoto", "espada", "espada lunar", "bomba"]; // Habilidades disponibles del enemigo
