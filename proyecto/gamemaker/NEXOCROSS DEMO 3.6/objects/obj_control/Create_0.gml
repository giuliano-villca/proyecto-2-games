...
// Inicializar los paneles con la estructura (el mayor logro)
global.panels = [
    [{tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}],
    [{tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}],
    [{tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 1, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}, {tipo: 1, propietario: 2, timer: -1}]
];