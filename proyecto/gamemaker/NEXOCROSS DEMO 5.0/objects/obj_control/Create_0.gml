...
// Crear temporizadores separados para regeneración y area_steal
global.panel_return_time = 5 * room_speed; // Tiempo de regeneración de paneles destruidos
global.robo_panel_duracion = 10 * room_speed; // Duración del efecto robo de panel como areal_steal o panel_grab
//no le hagas caso a las advertencias amarrilla, tal vez lo arregle en un futuro, ojo dije tal vez

global.panel_regeneracion_timer = global.panel_return_time;
global.robo_panel_timer = global.robo_panel_duracion;

global.temporary_panels = [];

// Inicializar los paneles con valores, incluyendo la propiedad `estructura`
global.panels = [
    [{tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}],
    [{tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}],
    [{tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 1, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}, {tipo: 1, propietario: 2, timer: -1, estructura: false}]
];

// Variables para manejar la victoria

global.victoria_jugador = false;
global.victoria_enemigo = false;
global.juego_activo = true;
global.room_siguiente = ""; // Room al que cambiar después de la victoria
global.tecla_activadora = -1; // Tecla para activar el botón
